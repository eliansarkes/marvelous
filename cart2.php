...
<?php
session_start();
include("handler/customerauth.php");
...
<?php
$total=0;
// the cart is an array so we are breaking it down into values
if (isset($_SESSION['cart'])) {
	//total functionallty

	
// so this will echo hello as the number of product in the cart
	foreach ($_SESSION['cart'] as $key => $value) {
		
		
		 

		$total=$total+$value['item_price']*$value['quantity'];    // every time the loop run it will add the item price to total
